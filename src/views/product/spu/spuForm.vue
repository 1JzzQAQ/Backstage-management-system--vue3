...
<template>
    <el-form label-width="100px">
        ...
        <el-form-item label="SPU品牌">
            <el-select v-model="SpuParams.tmId" style="width: 120px;">
        ...
        <el-form-item label="SPU销售属性">
            <!-- 展示销售属性的下拉菜单 -->
            <el-select style="width: 120px;" v-model="saleAttrIdAndValueName"
...
import type { SaleAttrValue, HasSaleAttr, SaleAttr, SpuImg, Trademark, AllTradeMark, SpuHasImg, SaleAttrResponseData, HasSaleAttrResponseData } from '@/api/product/spu/types';
